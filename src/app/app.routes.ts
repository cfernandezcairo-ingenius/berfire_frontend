...
export const routes: Routes = [
  ...
  { path: 'delivery-note-states/edit', component: DeliveryNoteStatesAddEditComponent, canActivate: [AuthGuard]},
  { path: 'delivery-note-states/edit/new', component: DeliveryNoteStatesAddEditComponent, canActivate: [AuthGuard]},
  { path: 'delivery-note-states/delete', component: DeliveryNoteStatesDeleteComponent, canActivate: [AuthGuard]},
  { path: 'invoice-status/list', component: BillStatusListComponent, canActivate: [AuthGuard]},
  { path: 'invoice-status/edit', component: BillStatusAddEditComponent, canActivate: [AuthGuard]},
  { path: 'invoice-status/delete', component: BillStatusDeleteComponent, canActivate: [AuthGuard]},
  { path: 'invoice-status/edit/new', component: BillStatusAddEditComponent, canActivate: [AuthGuard]},
  ...
  { path: 'statement-order/edit', component: StatementOrdersAddEditComponent, canActivate: [AuthGuard]},
  { path: 'statement-order/delete', component: StatementOrderDeleteComponent, canActivate: [AuthGuard]},
  { path: 'statement-order/edit/new', component: StatementOrdersAddEditComponent, canActivate:[AuthGuard]},
  { path: 'payment-forms/list', component: PaymenFormsListComponent, canActivate: [AuthGuard]},
  { path: 'payment-forms/edit', component: PaymentFormsAddEditComponent, canActivate: [AuthGuard]},
  { path: 'payment-forms/delete', component: StatementOrderDeleteComponent, canActivate: [AuthGuard]},
  { path: 'payment-forms/edit/new', component: StatementOrdersAddEditComponent, canActivate: [AuthGuard]},
  { path: 'request-status/list', component: RequestStatusListComponent, canActivate: [AuthGuard]},
  { path: 'request-status/edit', component: RequestStatusAddEditComponent, canActivate: [AuthGuard]},
  { path: 'request-status/delete', component: RequestStatusDeleteComponent, canActivate: [AuthGuard]},
  { path: 'request-status/edit/new', component: RequestStatusAddEditComponent, canActivate: [AuthGuard]},
  { path: 'work-status/list', component: WorkStatusListComponent, canActivate: [AuthGuard]},
  { path: 'work-status/edit', component: WorkStatusAddEditComponent, canActivate: [AuthGuard]},
  { path: 'work-status/delete', component: WorkStatusDeleteComponent, canActivate: [AuthGuard]},
  { path: 'work-status/edit/new', component: WorkStatusAddEditComponent, canActivate: [AuthGuard]},
  { path: 'banks/list', component: BanksListComponent, canActivate: [AuthGuard]},
  { path: 'banks/edit', component: BanksAddEditComponent, canActivate: [AuthGuard]},
  { path: 'banks/delete', component: BanksDeleteComponent, canActivate: [AuthGuard]},
  { path: 'banks/edit/new', component: BanksAddEditComponent, canActivate: [AuthGuard]},
  { path: 'populations/list', component: PopulationsListComponent, canActivate: [AuthGuard]},
  { path: 'populations/edit', component: PopulationsAddEditComponent, canActivate: [AuthGuard]},
  { path: 'populations/delete', component: PopulationsDeleteComponent, canActivate: [AuthGuard]},
  { path: 'populations/edit/new', component: PopulationsAddEditComponent, canActivate: [AuthGuard]},
  { path: 'unsubscribe-reasons/list', component: UnsubscribeReasonsListComponent, canActivate: [AuthGuard]},
  { path: 'unsubscribe-reasons/edit', component: UnsubscribeReasonsAddEditComponent, canActivate: [AuthGuard]},
  { path: 'unsubscribe-reasons/delete', component: UnsubscribeReasonsDeleteComponent , canActivate: [AuthGuard]},
  { path: 'unsubscribe-reasons/edit/new', component: UnsubscribeReasonsAddEditComponent, canActivate: [AuthGuard]},
  { path: 'clients-types/list', component: ClientsTypesListComponent, canActivate: [AuthGuard]},
  { path: 'clients-types/edit', component: ClientsTypesAddEditComponent, canActivate: [AuthGuard]},
  { path: 'clients-types/delete', component: ClientsTypesDeleteComponent , canActivate: [AuthGuard]},
  { path: 'clients-types/edit/new', component: ClientsTypesAddEditComponent, canActivate: [AuthGuard]},
  { path: 'contracts-types/list', component: ContractsTypesListComponent, canActivate: [AuthGuard]},
  { path: 'contracts-types/edit', component: ContractsTypesAddEditComponent, canActivate: [AuthGuard]},
  { path: 'contracts-types/delete', component: ContractsTypesDeleteComponent , canActivate: [AuthGuard]},
  { path: 'contracts-types/edit/new', component: ContractsTypesAddEditComponent, canActivate: [AuthGuard]},
  { path: 'taxes/list', component: TaxesListComponent, canActivate: [AuthGuard]},
  { path: 'taxes/edit', component: TaxesAddEditComponent, canActivate: [AuthGuard]},
  { path: 'taxes/delete', component: TaxesDeleteComponent , canActivate: [AuthGuard]},
  { path: 'taxes/edit/new', component: TaxesAddEditComponent, canActivate: [AuthGuard]},
  { path: 'pvp-rates/list', component: PvPRatesListComponent, canActivate: [AuthGuard]},
  { path: 'pvp-rates/edit', component: PVPRatesAddEditComponent, canActivate: [AuthGuard]},
  { path: 'pvp-rates/delete', component: PvpRatesDeleteComponent , canActivate: [AuthGuard]},
  { path: 'pvp-rates/edit/new', component: PVPRatesAddEditComponent, canActivate: [AuthGuard]},
  { path: 'states-parties-review/list', component: StatesPartiesReviewListComponent, canActivate: [AuthGuard]},
  { path: 'states-parties-review/edit', component: StatesPartiesReviewAddEditComponent, canActivate: [AuthGuard]},
  { path: 'states-parties-review/delete', component: StatesPartiesReviewDeleteComponent , canActivate: [AuthGuard]},
  { path: 'states-parties-review/edit/new', component: StatesPartiesReviewAddEditComponent, canActivate: [AuthGuard]},
  { path: 'manufacturers/list', component: ManufacturersListComponent, canActivate: [AuthGuard]},
  { path: 'manufacturers/edit', component: ManufacturersAddEditComponent, canActivate: [AuthGuard]},
  { path: 'manufacturers/delete', component: ManufacturersDeleteComponent , canActivate: [AuthGuard]},
  { path: 'manufacturers/edit/new', component: ManufacturersAddEditComponent, canActivate: [AuthGuard]},
  { path: 'technicals/list', component: TechnicalsListComponent, canActivate: [AuthGuard]},
  { path: 'technicals/edit', component: TechnicalsAddEditComponent, canActivate: [AuthGuard]},
  { path: 'technicals/delete', component: TechnicalsListComponent , canActivate: [AuthGuard]},
  { path: 'technicals/edit/new', component: TechnicalsAddEditComponent, canActivate: [AuthGuard]},
  { path: 'documents-templates/list', component: DocumentsTemplatesListComponent, canActivate: [AuthGuard]},
  { path: 'documents-templates/edit', component: DocumentsTemplatesAddEditComponent, canActivate: [AuthGuard]},
  { path: 'documents-templates/delete', component: DocumentsTemplatesDeleteComponent , canActivate: [AuthGuard]},
  { path: 'documents-templates/edit/new', component: DocumentsTemplatesAddEditComponent, canActivate: [AuthGuard]},
