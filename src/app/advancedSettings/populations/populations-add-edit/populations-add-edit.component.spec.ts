...
// describe('PopulationsAddEditComponent', () => {
...
//   it('should call the edit method of PopulationsService on new record', () => {
//     component.id = 0;
//     component.fg.setValue({ name: 'Test Bank', country: 'country 1', province: 'province 1' , active: false });
//     mockPopulationsService.add.and.returnValue(of({ success: true }));
//     const payload = { name: 'Test Bank', country: 'country 1', province: 'province 1' , active: false };
//     component.onSubmit(payload);
//     expect(mockPopulationsService.add).toHaveBeenCalledWith({
//       name: 'Test Bank', country: 'country 1', province: 'province 1' , active: false
//     });
//     expect(matSnackBarSpy.open).toHaveBeenCalled();
//   });

//   it('should call the edit method of PopulationsService on editing a record', () => {
//     component.id = 1;
//     component.fg.setValue({ name: 'Test Bank', country: 'country 1', province: 'province 1' , active: false });
//     mockPopulationsService.edit.and.returnValue(of({ success: true }));
//     component.onSubmit(component.model);
//     expect(mockPopulationsService.edit).toHaveBeenCalledWith({
//       id: 1,  name: 'Test Bank', country: 'country 1', province: 'province 1' , active: false });
//     expect(matSnackBarSpy.open).toHaveBeenCalled();
//   });
