...
const mockUnsubscribeReasonsService = {
...
describe('UnsubscribeReasonsAddEditComponent', () => {
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      ...
      providers: [
        ...
        { provide: UnsubscribeReasonsService, useValue: mockUnsubscribeReasonsService },
  ...
  it('should call the edit method of UnsubscribeReasonsService on new record', () => {
    component.id = 0;
    component.fg.setValue({ name: 'Test Bank', description: 'description 1' });
    mockUnsubscribeReasonsService.add.and.returnValue(of({ success: true }));
    const payload = { name: 'Test Bank', description: 'description 1' };
    component.onSubmit(payload);
    expect(mockUnsubscribeReasonsService.add).toHaveBeenCalledWith({
      name: 'Test Bank', description: 'description 1'
    });
    expect(matSnackBarSpy.open).toHaveBeenCalled();
  });

  it('should call the edit method of UnsubscribeReasonsService on editing a record', () => {
    component.id = 1;
    component.fg.setValue({ name: 'Test Bank', description: 'description 1' });
    mockUnsubscribeReasonsService.edit.and.returnValue(of({ success: true }));
    component.onSubmit(component.model);
    expect(mockUnsubscribeReasonsService.edit).toHaveBeenCalledWith({
