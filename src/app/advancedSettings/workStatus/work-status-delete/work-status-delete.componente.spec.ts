...
describe('WorkStatusDeleteComponent', () => {
  ...
  it('should handle delete service error gracefully', async () => {
    mockWorkStatusService.delete.and.returnValue(throwError(() => new Error('Error deleting'))); // Simulate an error
  ...
  it('should call delete service and show snackbar on user confirmation', async () => {
    ...
    expect(mockWorkStatusService.delete).toHaveBeenCalledWith(1);
  });
});
