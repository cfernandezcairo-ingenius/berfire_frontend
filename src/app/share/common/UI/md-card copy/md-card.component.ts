...
import { ChartComponent } from "../chart-pie/chart-pie.component";

@Component({
  selector: 'app-md-card',
  standalone: true,
  imports: [MatCard, MatCardHeader, MatCardSubtitle, MatCardTitle, MatCardActions, FormsModule, ReactiveFormsModule, CommonModule, ChartComponent],
