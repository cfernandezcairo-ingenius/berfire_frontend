...
import { StatementOrderDeleteComponent } from './statement-order-delete.component';
...
describe('StatementOrderDeleteComponent', () => {
  let component: StatementOrderDeleteComponent;
  let fixture: ComponentFixture<StatementOrderDeleteComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(StatementOrderDeleteComponent);
  ...
  it('should handle delete service error gracefully', async () => {
    mockStatementOrderService.delete.and.returnValue(throwError(() => new Error('Error deleting'))); // Simulate an error
  ...
  it('should call delete service and show snackbar on user confirmation', async () => {
    ...
    expect(mockStatementOrderService.delete).toHaveBeenCalledWith(1);
  });
});
