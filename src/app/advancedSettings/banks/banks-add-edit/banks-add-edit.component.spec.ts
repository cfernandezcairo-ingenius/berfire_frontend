...
describe('BanksAddEditComponent', () => {
  ...
  it('should initialize with default values and subscriptions', () => {
    ...
    expect(component.showinNewTab).toBeTrue();
  });
  ...
  it('should call the edit method of BanksService on new record', () => {
    component.id = 0;
    component.fg.setValue({ name: 'Test Bank', swift: '1234', iban: '5678' });
    mockBanksService.add.and.returnValue(of({ success: true }));
    const payload = { name: 'Test Bank', swift: '1234', iban: '5678' };
    component.onSubmit(payload);
    expect(mockBanksService.add).toHaveBeenCalledWith({
      name: 'Test Bank',
      swift: '1234',
      iban: 5678,
    });
  ...
  it('should call the edit method of BanksService on editing a record', () => {
    component.id = 1;
    component.fg.setValue({ name: 'Test Bank', swift: '1234', iban: '5678' });
    mockBanksService.edit.and.returnValue(of({ success: true }));
    component.onSubmit(component.model);
    expect(mockBanksService.edit).toHaveBeenCalledWith({
      id: 1,
      name: 'Test Bank',
      swift: '1234',
      iban: 5678,
