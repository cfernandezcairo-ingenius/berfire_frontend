...
describe('UnsubscribeReasonsDeleteComponent', () => {
  ...
  it('should handle delete service error gracefully', async () => {
    mockUnsubscribeReasonsService.delete.and.returnValue(throwError(() => new Error('Error deleting'))); // Simulate an error
  ...
  it('should call delete service and show snackbar on user confirmation', async () => {
    ...
    expect(mockUnsubscribeReasonsService.delete).toHaveBeenCalledWith(1);
  });
});
